...
import { restorePostVersion } from "@/features/admin/actions/posts";
import { Button } from "@/components/ui/button";
import type { VersionRow } from "@/features/admin/components/VersionHistory";
...
export function PostVersionHistory({ itemId, versions, backHref }: Props) {
  ...
  function handleRestore(versionId: string, vNum: number) {
    ...
    startTransition(() => {
      restorePostVersion(itemId, versionId);
    });
  }
